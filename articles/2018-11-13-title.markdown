...
* wait for the redirect to our web application and proceed on our merry way.
...
In order to get our Cypress authentication working with Auth0, there are a few more things we have to do.
